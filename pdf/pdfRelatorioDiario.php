...
<tbody>');
    ...
    $query1 = "SELECT prefixo, servicos, kminicio, kmfim FROM `gestaocmv` WHERE data_req = '$data' AND polo = $polo_vg AND periodo = $periodo ORDER BY prefixo ASC";
    $result1 = mysqli_query($conn, $query1);
    
    $query2 = "SELECT prefixo, servicos, kminicio, kmfim FROM `gestaocmv` WHERE data_req = '$data' AND polo = $polo_vm AND periodo = $periodo ORDER BY prefixo ASC";
    ...
    $n = $result2->num_rows;
    $n = $n -1;
    while ($consulta_result = mysqli_fetch_assoc($result1)) {
        $dif = $consulta_result['kmfim'] - $consulta_result['kminicio'];
        $mpdf->WriteHTML('<tr>
