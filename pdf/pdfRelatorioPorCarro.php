...
for ($i = 0; $i <= $diasDoMes; $i++) {
    ...
    if ($i != 0) {
        ...
        $queryvg = "SELECT * FROM `gestaocmv` WHERE data_req = '$data' AND (polo = '1' OR polo = '2') AND periodo = '0' AND prefixo = '$prefixo'";
       ...
       // echo mysqli_errno($conn) . ": " . mysqli_error($conn). "\n";
        ...
        $queryvg = "SELECT servicos, kmfim, kminicio FROM `gestaocmv` WHERE data_req = '$data' AND (polo = '1' OR polo = '2') AND periodo = '1' AND prefixo = '$prefixo'";
        ...
        $queryvm = "SELECT servicos, kmfim, kminicio FROM `gestaocmv` WHERE data_req = '$data' AND (polo = '3' OR polo = '4') AND periodo = '0' AND prefixo = '$prefixo'";
        ...
        $queryvm = "SELECT servicos, kmfim, kminicio FROM `gestaocmv` WHERE data_req = '$data' AND (polo = '3' OR polo = '4') AND periodo = '1' AND prefixo = '$prefixo'";
...
$mpdf->Output('Relatorio_por_carro-'.$prefixo.'.pdf', 'D');
