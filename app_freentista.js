...
function scan(t) {
    ...
    // } else {
    //     scanner = new Instascan.Scanner({
    //         video: document.getElementById('cam2'),
    //         scanPeriod: 5,
    //         mirror: false,
    //     });
    // }
        ...
        if (cameras.length > 0) {
            for (let c = 0; c < cameras.length; c++) {
                if (cameras[c].name.indexOf('back') != -1) {
                    ...
                    // console.log(cameras[c].name.indexOf('back'))
                }
            }
    ...
    $.ajax({
        ...
        success: function(data) {
                ...
                if (data == '' || data == null || data == 'false' || data == false) {
                    ...
                    $('#menssagemAlerta').text('QR-Code Inválido ou morotista indisponível')
                } else {
            ...
            if ($("#cadastrarComb").val == null) {
                ...
                if ($('#cadastrarVal').val() == null || $('#cadastrarVal').val() <= 0) {
                    ...
                    if ($('#cadastrarVal').val() == null) {
                        ...
                        $('#textBody').text('Enquadre na foto o valor e  quantidade de litro na abastecimento');
